...
import {
  ...
  addNpcStat, moveNpc,
  discoverLocation, option, scene, scenes,
  move, time,
...
function robFirstTour(): Instruction {
  return scenes(
    ...
    scene(
      ...
      option('Tell him you\'re impressed',
        seq(say('You should see it at sunset — the brass catches the light something beautiful.'),
        'He looks pleased by your reaction.',
        addNpcStat('affection', 1, { max: 10, hidden: true }),
      )),
      option('Nod politely',
        seq('You take in the sights. Rob watches your face, gauging your reaction.',
    ...
    scene(
      ...
      option('Ask about his favourite stall',
        seq(say('Oh — there\'s a fellow who sells miniature clockwork birds. Completely useless, absolutely charming. I\'ve got three.'),
        'He grins, embarrassed.',
        addNpcStat('affection', 1, { max: 10, hidden: true }),
      )),
      option('Keep moving',
        seq('You press through the crowd. Rob stays close, one hand hovering near your elbow.',
      )),
    ),
    // Backstreets
    scene(
    ...
    scene(
      random(
        seq(
          ...
          option('Dance a few steps',
            seq('You sway to the music. Rob laughs — surprised, delighted — and does a clumsy little shuffle of his own.',
            addNpcStat('affection', 2, { max: 25, hidden: true }),
          )),
          option('Listen for a moment',
            seq('You stand together, letting the tinny melody wash over you. Rob hums along under his breath.',
          )),
        ),
        seq(
    ...
    scene(
      ...
      cond(
        ...
        seq(
          ...
          option('Squeeze his hand',
            seq('You squeeze his hand. He lifts yours to his lips and kisses your knuckles.',
            say('I\'m a lucky man.'),
            addNpcStat('affection', 2, { max: 70, hidden: true }),
          )),
          option('Tease him about his tour script',
            seq(say('Oi! I\'ll have you know that script is very well written.'),
        ...
        seq(
          ...
          when(stat('Flirtation', 1),
            seq(
              option('Flirt back',
                seq('You tell him you enjoy his company too — more than he probably realises.',
                say('I — really? That\'s — blimey.'),
                'His ears go pink. He\'s trying very hard not to grin.',
                addNpcStat('affection', 2, { max: 25 }),
              )),
              option('Smile warmly',
                seq('You give him a warm smile. He relaxes, matching it with one of his own.',
                addNpcStat('affection', 1, { max: 25, hidden: true }),
              )),
            ),
          ),
...
registerNPC('tour-guide', {
  ...
  scripts: {
    ...
    roomChat: seq(
      ...
      option('Chat', run('npc:roomChat')),
      when(hasRelationship('boyfriend'),
        option('Kiss him', run('npc:quickKiss')),
      ),
      when(stat('Flirtation', 1),
        option('Flirt', run('npc:flirt')),
      ),
      when(hasRelationship('boyfriend'),
        option('Break up', run('npc:breakup')),
      ),
      npcLeaveOption('You leave Rob to it for now.', undefined, 'Do something else'),
      option('Depart Room', run('npc:leaveRoom')),
    ),
    ...
    robVisit: scenes(
      scene(
        ...
        option('Come in',
          seq('You step aside and he slips through the doorway.',
          npcInteract('lodgingsChat'),
        )),
        option('It\'s not a good time',
          seq(// Charm check: let him down gently to reduce the sting
          skillCheck('Charm', 10,
            seq(
    ...
    lodgingsChat: seq(
      ...
      when(or(hasCard('flushed'), stat('Flirtation', 20)),
        option('Pull him to the bed', run('npc:makeOut')),
      ),
      npcLeaveOption('You leave Rob to it for now.', undefined, 'Do something else'),
    ...
    lodgingsKiss: seq(
      ...
      kiss(5),
      option('Chat', run('npc:lodgingsChat')),
      option('Kiss him again', run('npc:lodgingsKiss')),
      when(or(hasCard('flushed'), stat('Flirtation', 20)),
        option('Pull him to the bed', run('npc:makeOut')),
      ),
      npcLeaveOption('You leave Rob to it for now.', undefined, 'Do something else'),
    ...
    makeOutMenu: seq(
      ...
      option('Keep going', run('npc:makeOutMenu')),
      option('Kiss him', run('npc:makeOutKiss')),
      option('Slow down', seq(
    ...
    makeOutKiss: seq(
      ...
      option('Keep going', run('npc:makeOutMenu')),
      option('Kiss him again', run('npc:makeOutKiss')),
      option('Slow down',
        seq(cond(
          npcStat('madeLove'),
          skillCheck('Charm', 12,
    ...
    morningDepart: seq(
      ...
      option('Kiss him goodbye',
        seq('You pull him close and kiss him. He lingers a moment longer than he should.',
        kiss(5),
        say('Now I\'m definitely going to be late.'),
        'He grins and slips out the door.',
      )),
      option('See you later',
        seq(say('See you later, love.'),
        'He squeezes your hand, then he\'s gone.',
      )),
    ),
    ...
    breakup: scenes(
      ...
      scene(
        ...
        option('I changed my mind',
          seq(say('Don\'t scare me like that!'),
...
function robNormalDate(): Instruction {
  return scenes(
    ...
    scene(
      ...
      option('Lean against him',
        seq('You lean against his shoulder. He tenses for a moment, then relaxes, letting out a slow breath.',
      ...
      option('Stay where you are',
        seq('You keep a comfortable distance, watching the steam curl over the water.',
    ...
    scene(
      ...
      cond(
        ...
        seq(
          ...
          option('Go to the hidden garden', robGardenPath()),
          option('Stick to the pier', robPierPath()),
        ),
        ...
        seq(
          ...
          option('Walk to the pier', robPierPath()),
        ),
      ),
    ),
  )
...
function robBoyfriendDate(): Instruction {
  return scenes(
    ...
    scene(
      ...
      option('Lean into him',
        seq('You rest your head against his shoulder. He presses his cheek against your hair.',
        say('This. Right here. This is everything.'),
        addNpcStat('affection', 3, { max: 70 }),
      )),
      option('Tease him',
        seq('You tell him he was never interesting to begin with.',
    ...
    scene(
      random(
        ...
        seq(
          ...
          option('Dance with him',
            seq('You sway together to the terrible music, laughing too hard to keep time. Other walkers give you odd looks. Neither of you cares.',
            addNpcStat('affection', 3, { max: 70 }),
          )),
          option('Applaud the busker',
            seq('You clap enthusiastically. The clockwork performer bows, gears clicking.',
...
function robPierPath(): Instruction {
  return scenes(
    ...
    scene(
      ...
      option('Take his hand',
        seq('You reach over and lace your fingers through his. He freezes — then holds on as though you might vanish.',
      ...
      option('Enjoy the view',
        seq('You gaze up at the stars together, the lantern-light warm on your faces.',
...
function robGardenPath(): Instruction {
  return scenes(
    ...
    scene(
      ...
      option('Sit close beside him',
        seq('You sit next to him, close enough that your shoulders press together. He exhales — a long, shaky breath — and you feel some tension leave him.',
        addNpcStat('affection', 3, { max: 50 }),
        say('I don\'t really know what I\'m doing,'),
        'he admits quietly.',
        say('But I\'m glad I\'m doing it with you.'),
      )),
      option('Sit across from him',
        seq('You take a seat on the stone bench opposite. The fountain stands between you like a gentle chaperone.',
      ...
      cond(
        ...
        seq(
          ...
          option('I\'m not ready',
            seq('His smile freezes, then slowly crumbles.',
    ...
    scene(
      ...
      cond(
        ...
        seq(
          ...
          option('Goodnight',
            seq(say('Goodnight, love. I\'ll see you soon.'),
